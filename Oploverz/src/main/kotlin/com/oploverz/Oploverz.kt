...
class Oploverz : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        "series/?status=ongoing&order=update" to "Update Terbaru",
        "series/?status=ongoing&order&order=popular" to "Paling Populer",
        "series/?" to "Anime",
        "series/?status=&type=movie&page=" to "Movies",
        "series/?status=completed&order=update" to "Completed"
    )
